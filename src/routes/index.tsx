        ...
        <div className="bg-[#111111] text-[#F2F2F2]">
          ...
          <section className="relative w-full overflow-hidden h-[85svh] min-h-[520px] max-h-[850px] flex flex-col justify-end">
            ...
            <div className="relative z-10 h-full flex flex-col items-center text-center px-6 pt-12 pb-12">
              ...
              <a
                href="#subscribe"
                className="mt-10 inline-flex items-center gap-3 bg-[#D8F90A] text-[#1E1E1E] font-medium rounded-full px-8 py-4 hover:bg-[#c9ea00] hover:-translate-y-0.5 transition-all duration-200"
              >
                Subscribe Free
                <ArrowRight className="w-5 h-5" strokeWidth={2.5} />
              </a>
              ...
              <div className="flex items-center gap-3 mt-6">
                <div className="flex -space-x-2">
                  <img
                    className="w-6 h-6 rounded-full border-[1.5px] border-[#111] object-cover"
          ...
          <div className="px-4 sm:px-[42px] pb-10">
            <a
              ...
              className="block overflow-hidden rounded-[14px] group"
            >
              <video
                autoPlay
                muted
